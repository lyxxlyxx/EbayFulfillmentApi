...
class IssueRefundRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'refund_items' => '\EbayFulfillmentApi\Model\RefundItem[]',
        'order_level_refund_amount' => '\EbayFulfillmentApi\Model\SimpleAmount'
    ];
     ...
     * Gets refund_items
     *
     * @return \EbayFulfillmentApi\Model\RefundItem[]|null
     */
     ...
     * Sets refund_items
     *
     * @param \EbayFulfillmentApi\Model\RefundItem[]|null $refund_items The refundItems array is only required if the seller is issuing a refund for one or more individual order line items in a multiple line item order. Otherwise, the seller just uses the orderLevelRefundAmount container to specify the amount of the refund for the entire order.
     *
     * @return $this
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\SimpleAmount|null $order_level_refund_amount order_level_refund_amount
     *
     * @return $this
     */
