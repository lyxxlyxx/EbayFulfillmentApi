...
class PaymentHold implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'hold_amount' => '\EbayFulfillmentApi\Model\Amount',
        'hold_reason' => 'string',
        'hold_state' => 'string',
        'release_date' => 'string',
        'seller_actions_to_release' => '\EbayFulfillmentApi\Model\SellerActionsToRelease[]'
    ];
     ...
     * Sets hold_amount
     *
     * @param \EbayFulfillmentApi\Model\Amount|null $hold_amount hold_amount
     *
     * @return $this
     */
     ...
     *
     * @return \EbayFulfillmentApi\Model\SellerActionsToRelease[]|null
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\SellerActionsToRelease[]|null $seller_actions_to_release A list of one or more possible actions that the seller can take to expedite the release of the payment hold.
     *
     * @return $this
     */
