...
class OrderSearchPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'offset' => 'int',
        'orders' => '\EbayFulfillmentApi\Model\Order[]',
        'prev' => 'string',
        'total' => 'int',
     ...
     * Gets orders
     *
     * @return \EbayFulfillmentApi\Model\Order[]|null
     */
     ...
     * Sets warnings
     *
     * @param \EbayFulfillmentApi\Model\Error[]|null $warnings This array is returned if one or more errors or warnings occur with the call request.
     *
     * @return $this
     */
