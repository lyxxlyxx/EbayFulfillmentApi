...
class ShippingFulfillmentPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'fulfillments' => '\EbayFulfillmentApi\Model\ShippingFulfillment[]',
        'total' => 'int',
        'warnings' => '\EbayFulfillmentApi\Model\Error[]'
    ];
     ...
     * Gets fulfillments
     *
     * @return \EbayFulfillmentApi\Model\ShippingFulfillment[]|null
     */
     ...
     * Sets fulfillments
     *
     * @param \EbayFulfillmentApi\Model\ShippingFulfillment[]|null $fulfillments This array contains one or more fulfillments required for the order that was specified in method endpoint.
     *
     * @return $this
     */
     ...
     * Gets warnings
     *
     * @return \EbayFulfillmentApi\Model\Error[]|null
     */
     ...
     * Sets warnings
     *
     * @param \EbayFulfillmentApi\Model\Error[]|null $warnings This array is only returned if one or more errors or warnings occur with the call request.
     *
     * @return $this
     */
