...
class DisputeEvidence implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'files' => '\EbayFulfillmentApi\Model\FileInfo[]',
        'line_items' => '\EbayFulfillmentApi\Model\OrderLineItems[]',
        'provided_date' => 'string',
        'request_date' => 'string',
        'respond_by_date' => 'string',
        'shipment_tracking' => '\EbayFulfillmentApi\Model\TrackingInfo[]'
    ];
     ...
     * Gets files
     *
     * @return \EbayFulfillmentApi\Model\FileInfo[]|null
     */
     ...
     * Sets files
     *
     * @param \EbayFulfillmentApi\Model\FileInfo[]|null $files This array shows the name, ID, file type, and upload date for each provided file.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \EbayFulfillmentApi\Model\OrderLineItems[]|null $line_items This array shows one or more order line items associated with the evidential document that has been provided.
     *
     * @return $this
     */
     ...
     *
     * @return \EbayFulfillmentApi\Model\TrackingInfo[]|null
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\TrackingInfo[]|null $shipment_tracking This array shows the shipping carrier and shipment tracking number associated with each shipment package of the order. This array is returned if the seller has provided shipment tracking information as evidence to support PROOF_OF_DELIVERY.
     *
     * @return $this
     */
