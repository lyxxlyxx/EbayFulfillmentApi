...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'applied_promotions' => '\EbayFulfillmentApi\Model\AppliedPromotion[]',
        'delivery_cost' => '\EbayFulfillmentApi\Model\DeliveryCost',
        'discounted_line_item_cost' => '\EbayFulfillmentApi\Model\Amount',
        'ebay_collect_and_remit_taxes' => '\EbayFulfillmentApi\Model\EbayCollectAndRemitTax[]',
        'gift_details' => '\EbayFulfillmentApi\Model\GiftDetails',
        'legacy_item_id' => 'string',
        'legacy_variation_id' => 'string',
        'line_item_cost' => '\EbayFulfillmentApi\Model\Amount',
        'line_item_fulfillment_instructions' => '\EbayFulfillmentApi\Model\LineItemFulfillmentInstructions',
        'line_item_fulfillment_status' => 'string',
        'line_item_id' => 'string',
        'listing_marketplace_id' => 'string',
        'properties' => '\EbayFulfillmentApi\Model\LineItemProperties',
        'purchase_marketplace_id' => 'string',
        'quantity' => 'int',
        'refunds' => '\EbayFulfillmentApi\Model\LineItemRefund[]',
        'sku' => 'string',
        'sold_format' => 'string',
        'taxes' => '\EbayFulfillmentApi\Model\Tax[]',
        'title' => 'string',
        'total' => '\EbayFulfillmentApi\Model\Amount'
    ];
     ...
     *
     * @return \EbayFulfillmentApi\Model\AppliedPromotion[]|null
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\AppliedPromotion[]|null $applied_promotions This array contains information about one or more sales promotions or discounts applied to the line item. It is always returned, but will be returned as an empty array if no special sales promotions or discounts apply to the order line item.
     *
     * @return $this
     */
     ...
     * Gets delivery_cost
     *
     * @return \EbayFulfillmentApi\Model\DeliveryCost|null
     */
     ...
     * Sets delivery_cost
     *
     * @param \EbayFulfillmentApi\Model\DeliveryCost|null $delivery_cost delivery_cost
     *
     * @return $this
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\Amount|null $discounted_line_item_cost discounted_line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \EbayFulfillmentApi\Model\EbayCollectAndRemitTax[]|null
     */
     ...
     * Gets gift_details
     *
     * @return \EbayFulfillmentApi\Model\GiftDetails|null
     */
     ...
     * Sets gift_details
     *
     * @param \EbayFulfillmentApi\Model\GiftDetails|null $gift_details gift_details
     *
     * @return $this
     */
     ...
     * Sets line_item_cost
     *
     * @param \EbayFulfillmentApi\Model\Amount|null $line_item_cost line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \EbayFulfillmentApi\Model\LineItemFulfillmentInstructions|null
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\LineItemFulfillmentInstructions|null $line_item_fulfillment_instructions line_item_fulfillment_instructions
     *
     * @return $this
     */
     ...
     * Gets properties
     *
     * @return \EbayFulfillmentApi\Model\LineItemProperties|null
     */
     ...
     * Sets properties
     *
     * @param \EbayFulfillmentApi\Model\LineItemProperties|null $properties properties
     *
     * @return $this
     */
     ...
     * Gets refunds
     *
     * @return \EbayFulfillmentApi\Model\LineItemRefund[]|null
     */
     ...
     * Sets refunds
     *
     * @param \EbayFulfillmentApi\Model\LineItemRefund[]|null $refunds This array is always returned, but is returned as an empty array unless the seller has submitted a partial or full refund to the buyer for the order. If a refund has occurred, the refund amount and refund date will be shown for each refund.
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \EbayFulfillmentApi\Model\Tax[]|null
     */
     ...
     * Sets taxes
     *
     * @param \EbayFulfillmentApi\Model\Tax[]|null $taxes Contains a list of taxes applied to the line item, if any. This array is always returned, but will be returned as empty if no taxes are applicable to the line item, or if the seller is opted in to eBay managed payments.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param \EbayFulfillmentApi\Model\Amount|null $total total
     *
     * @return $this
     */
