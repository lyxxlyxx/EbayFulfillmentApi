...
class DisputeSummaryResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'offset' => 'int',
        'payment_dispute_summaries' => '\EbayFulfillmentApi\Model\PaymentDisputeSummary[]',
        'prev' => 'string',
        'total' => 'int'
    ];
     ...
     *
     * @return \EbayFulfillmentApi\Model\PaymentDisputeSummary[]|null
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\PaymentDisputeSummary[]|null $payment_dispute_summaries Each payment dispute that matches the input criteria is returned under this array. If no payment disputes are found, an empty array is returned.
     *
     * @return $this
     */
