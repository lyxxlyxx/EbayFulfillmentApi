...
class Payment implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'payment_date' => 'string',
        'payment_holds' => '\EbayFulfillmentApi\Model\PaymentHold[]',
     ...
     * Gets payment_holds
     *
     * @return \EbayFulfillmentApi\Model\PaymentHold[]|null
     */
     ...
     * Sets payment_holds
     *
     * @param \EbayFulfillmentApi\Model\PaymentHold[]|null $payment_holds This container is only returned if eBay is temporarily holding the seller's funds for the order. If a payment hold has been placed on the order, this container includes the reason for the payment hold, the expected release date of the funds into the seller's account, the current state of the hold, and as soon as the payment hold has been released, the actual release date.
     *
     * @return $this
     */
