...
class PaymentSummary implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'payments' => '\EbayFulfillmentApi\Model\Payment[]',
        'refunds' => '\EbayFulfillmentApi\Model\OrderRefund[]',
        'total_due_seller' => '\EbayFulfillmentApi\Model\Amount'
    ];
     ...
     * Gets payments
     *
     * @return \EbayFulfillmentApi\Model\Payment[]|null
     */
     ...
     * Gets refunds
     *
     * @return \EbayFulfillmentApi\Model\OrderRefund[]|null
     */
     ...
     * Sets refunds
     *
     * @param \EbayFulfillmentApi\Model\OrderRefund[]|null $refunds This array is always returned, but is returned as an empty array unless the seller has submitted a partial or full refund to the buyer for the order. If a refund has occurred, the refund amount and refund date will be shown for each refund.
     *
     * @return $this
     */
     ...
     *
     * @param \EbayFulfillmentApi\Model\Amount|null $total_due_seller total_due_seller
     *
     * @return $this
     */
