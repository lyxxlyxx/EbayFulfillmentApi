...
class ShippingFulfillmentApi
{
     ...
     * @param  \EbayFulfillmentApi\Model\ShippingFulfillmentDetails $shipping_fulfillment_details fulfillment payload (required)
     *
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\ShippingFulfillment
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\ShippingFulfillment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentWithHttpInfo($fulfillment_id, $order_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\ShippingFulfillment' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\ShippingFulfillment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\ShippingFulfillment';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\ShippingFulfillment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentsWithHttpInfo($order_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\ShippingFulfillmentPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
