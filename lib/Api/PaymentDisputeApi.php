...
namespace EbayFulfillmentApi\Api;
...
use EbayFulfillmentApi\HeaderSelector;
...
class PaymentDisputeApi
{
     ...
     * @param  \EbayFulfillmentApi\Model\AcceptPaymentDisputeRequest $accept_payment_dispute_request accept_payment_dispute_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to accept. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \EbayFulfillmentApi\Model\AcceptPaymentDisputeRequest $accept_payment_dispute_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \EbayFulfillmentApi\Model\AddEvidenceRequest $add_evidence_request add_evidence_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\AddEvidenceResponse
     */
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to add evidence for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \EbayFulfillmentApi\Model\AddEvidenceRequest $add_evidence_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\AddEvidenceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addEvidenceWithHttpInfo($payment_dispute_id, $add_evidence_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\AddEvidenceResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\AddEvidenceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\AddEvidenceResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\AddEvidenceResponse',
     ...
     * @param  \EbayFulfillmentApi\Model\ContestPaymentDisputeRequest $contest_payment_dispute_request contest_payment_dispute_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to contest. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \EbayFulfillmentApi\Model\ContestPaymentDisputeRequest $contest_payment_dispute_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\PaymentDisputeActivityHistory
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\PaymentDisputeActivityHistory, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActivitiesWithHttpInfo($payment_dispute_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\PaymentDisputeActivityHistory' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\PaymentDisputeActivityHistory', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\PaymentDisputeActivityHistory';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\PaymentDisputeActivityHistory',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\PaymentDispute
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\PaymentDispute, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentDisputeWithHttpInfo($payment_dispute_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\PaymentDispute' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\PaymentDispute', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\PaymentDispute';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\PaymentDispute',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\DisputeSummaryResponse
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\DisputeSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentDisputeSummariesWithHttpInfo($order_id = null, $buyer_username = null, $open_date_from = null, $open_date_to = null, $payment_dispute_status = null, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\DisputeSummaryResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\DisputeSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\DisputeSummaryResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\DisputeSummaryResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \EbayFulfillmentApi\Model\UpdateEvidenceRequest $update_evidence_request update_evidence_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $payment_dispute_id This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to update the evidence set for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. (required)
     * @param  \EbayFulfillmentApi\Model\UpdateEvidenceRequest $update_evidence_request (optional)
     *
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayFulfillmentApi\Model\FileEvidence
     */
     ...
     * @throws \EbayFulfillmentApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayFulfillmentApi\Model\FileEvidence, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadEvidenceFileWithHttpInfo($payment_dispute_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayFulfillmentApi\Model\FileEvidence' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayFulfillmentApi\Model\FileEvidence', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayFulfillmentApi\Model\FileEvidence';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayFulfillmentApi\Model\FileEvidence',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
