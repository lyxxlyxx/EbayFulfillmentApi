...
------------ | ------------- | ------------- | -------------
**line_items** | [**\EbayFulfillmentApi\Model\LineItemReference[]**](LineItemReference.md) | This array contains a list of or more line items and the quantity that will be shipped in the same package. | [optional] 
