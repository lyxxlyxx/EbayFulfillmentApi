...
> \EbayFulfillmentApi\Model\Order getOrder($order_id, $field_groups)
...
> \EbayFulfillmentApi\Model\OrderSearchPagedCollection getOrders($field_groups, $filter, $limit, $offset, $order_ids)
