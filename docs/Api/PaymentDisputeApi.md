# EbayFulfillmentApi\PaymentDisputeApi
...
$apiInstance = new EbayFulfillmentApi\Api\PaymentDisputeApi(
...
$accept_payment_dispute_request = new \EbayFulfillmentApi\Model\AcceptPaymentDisputeRequest(); // \EbayFulfillmentApi\Model\AcceptPaymentDisputeRequest | 
 ...
 **accept_payment_dispute_request** | [**\EbayFulfillmentApi\Model\AcceptPaymentDisputeRequest**](../Model/AcceptPaymentDisputeRequest.md)|  | [optional]
...
> \EbayFulfillmentApi\Model\AddEvidenceResponse addEvidence($payment_dispute_id, $add_evidence_request)
...
$add_evidence_request = new \EbayFulfillmentApi\Model\AddEvidenceRequest(); // \EbayFulfillmentApi\Model\AddEvidenceRequest | 
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to add evidence for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **add_evidence_request** | [**\EbayFulfillmentApi\Model\AddEvidenceRequest**](../Model/AddEvidenceRequest.md)|  | [optional]

### Return type

[**\EbayFulfillmentApi\Model\AddEvidenceResponse**](../Model/AddEvidenceResponse.md)
...
$contest_payment_dispute_request = new \EbayFulfillmentApi\Model\ContestPaymentDisputeRequest(); // \EbayFulfillmentApi\Model\ContestPaymentDisputeRequest | 
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to contest. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **contest_payment_dispute_request** | [**\EbayFulfillmentApi\Model\ContestPaymentDisputeRequest**](../Model/ContestPaymentDisputeRequest.md)|  | [optional]
...
> \EbayFulfillmentApi\Model\PaymentDisputeActivityHistory getActivities($payment_dispute_id)
...
[**\EbayFulfillmentApi\Model\PaymentDisputeActivityHistory**](../Model/PaymentDisputeActivityHistory.md)
...
> \EbayFulfillmentApi\Model\PaymentDispute getPaymentDispute($payment_dispute_id)
...
[**\EbayFulfillmentApi\Model\PaymentDispute**](../Model/PaymentDispute.md)
...
> \EbayFulfillmentApi\Model\DisputeSummaryResponse getPaymentDisputeSummaries($order_id, $buyer_username, $open_date_from, $open_date_to, $payment_dispute_status, $limit, $offset)
...
[**\EbayFulfillmentApi\Model\DisputeSummaryResponse**](../Model/DisputeSummaryResponse.md)
...
$update_evidence_request = new \EbayFulfillmentApi\Model\UpdateEvidenceRequest(); // \EbayFulfillmentApi\Model\UpdateEvidenceRequest | 
...
------------- | ------------- | ------------- | -------------
 **payment_dispute_id** | **string**| This is the unique identifier of the payment dispute. This path parameter must be passed into the call URI to identify the payment dispute for which the user plans to update the evidence set for a contested payment dispute. This identifier is automatically created by eBay once the payment dispute comes into the eBay managed payments system. The unique identifier for payment disputes is returned in the paymentDisputeId field in the getPaymentDisputeSummaries response. This path parameter is required, and the actual identifier value is passed in right after the payment_dispute resource. See the Resource URI above. |
 **update_evidence_request** | [**\EbayFulfillmentApi\Model\UpdateEvidenceRequest**](../Model/UpdateEvidenceRequest.md)|  | [optional]
...
> \EbayFulfillmentApi\Model\FileEvidence uploadEvidenceFile($payment_dispute_id)
...
[**\EbayFulfillmentApi\Model\FileEvidence**](../Model/FileEvidence.md)
